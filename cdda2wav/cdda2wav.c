/* @(#)cdda2wav.c	1.174 20/02/26 Copyright 1993-2004,2015,2017 Heiko Eissfeldt, Copyright 2004-2020 J. Schilling */
#include "config.h"
#ifndef lint
	...
	char	*argv[];
{
	...
	if (version) {
		 ...
		 */
		printf(_("cdda2wav %s %s (%s-%s-%s) Copyright (C) 1993-2004,2015,2017,2019 %s (C) 2004-2020 %s\n"),
					VERSION,
					VERSION_DATE,
