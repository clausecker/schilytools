/* @(#)bsh.c	1.73 16/05/03 Copyright 1984,1985,1988,1989,1991,1994-2016 J. Schilling */
#include <schily/mconfig.h>
#ifndef lint
static	UConst char sccsid[] =
	"@(#)bsh.c	1.73 16/05/03 Copyright 1982,1984,1985,1988,1989,1991,1994-2016 J. Schilling";
#endif
/*
 *	bsh command interpreter - main Program
 *
 *	Copyright (c) 1982,1984,1985,1988,1989,1991,1994-2016 J. Schilling
 */
/*
...
/*	char	bshopts[]	= "v,V,i,c,e,h,2,g,l,n,s,t,f,F,o&,q,alias-owner*,noclose,help,version";*/
	...
	if (prversion) {
		...
		printf("Copyright (C) 1982, 1984, 1985, 1988-1989, 1991, 1994-2016 Jörg Schilling\n");
