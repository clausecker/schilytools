...
/*
 * From "@(#)textmem.c	1.18	07/03/15 SMI"
 */
...
#define	mutex_lock(a)	(0)
#define	mutex_unlock(a)	(0)
...
#ifndef	MAP_FAILED
#define	MAP_FAILED	(struct page *)-1
#endif
		int	f;
		...
		page = (struct page *)mmap(0, mmap_sizeparm(totpage),
			PROT_READ|PROT_WRITE, MAP_PRIVATE|MAP_ANONYMOUS, f, 0);
#else
