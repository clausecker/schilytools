/* @(#)caplist.c	1.7 08/01/09 Copyright 2000-2008 J. Schilling */
/*
...
{ "cs",	"csr",		"change_scroll_region",		"change region to line #1 to line #2 (P)" },
...
{ "ch",	"hpa",		"column_address",		"horizontal position #1, absolute (P)" },
{ "CC",	"cmdch",	"command_character",		"terminal settable cmd character in prototype" },
{ "cm",	"cup",		"cursor_address",		"move to row #1 columns #2" },
...
{ "CM",	"mrcup",	"cursor_mem_address",		"memory relative cursor addressing" },
...
{ "ec",	"ech",		"erase_chars",			"erase #1 characters (P)" },
...
{ "DC",	"dch",		"parm_dch",			"delete #1 chars (P*)" },
{ "DL",	"dl",		"parm_delete_line",		"delete #1 lines (P*)" },
{ "DO",	"cud",		"parm_down_cursor",		"down #1 lines (P*)" },
{ "IC",	"ich",		"parm_ich",			"insert #1 chars (P*)" },
{ "SF",	"indn",		"parm_index",			"scroll forward #1 lines (P)" },
{ "AL",	"il",		"parm_insert_line",		"insert #1 lines (P*)" },
{ "LE",	"cub",		"parm_left_cursor",		"move #1 chars to the left (P)" },
{ "RI",	"cuf",		"parm_right_cursor",		"move #1 chars to the right (P*)" },
{ "SR",	"rin",		"parm_rindex",			"scroll back #1 lines (P)" },
{ "UP",	"cuu",		"parm_up_cursor",		"up #1 lines (P*)" },
...
{ "rp",	"rep",		"repeat_char",			"repeat char #1 #2 times (P*)" },
...
{ "cv",	"vpa",		"row_address",			"vertical position #1 absolute (P)" },
...
{ "sa",	"sgr",		"set_attributes",		"define video attributes #1-#9 (PG9)" },
{ "st",	"hts",		"set_tab",			"set a tab in every row, current columns" },
{ "wi",	"wind",		"set_window",			"current window is lines #1-#2 cols #3-#4" },
{ "ta",	"ht",		"tab",				"tab to next 8-space hardware tab stop" },
{ "ts",	"tsl",		"to_status_line",		"move to status line" },
...
{ "pO",	"mc5p",		"prtr_non",			"turn on printer for #1 bytes" },
...
{ "pn",	"pln",		"plab_norm",			"program label #1 to show string #2" },
