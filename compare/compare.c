/* @(#)compare.c	1.18 07/02/05 Copyright 1985, 88, 96-99, 2000-2004 J. Schilling */
#ifndef lint
static	char sccsid[] =
	"@(#)compare.c	1.18 07/02/05 Copyright 1985, 88, 96-99, 2000-2004 J. Schilling";
#endif
 ...
 *
 *	Copyright (c) 1985, 88, 96-99, 2000-2004 J. Schilling
 */
/*
...
/*	long	bpos2	= 0;*/
	...
	if (help)
		usage(0);
	if (prversion) {
		printf("Compare release %s (%s-%s-%s) Copyright (C) 1985, 88, 96-99, 2000-2004 Jörg Schilling\n",
				"1.18",
